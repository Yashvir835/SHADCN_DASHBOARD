...
export function SidebarHeader() {
  ...
  return (
    <div className="flex gap-2 hide-scrollbar py-2">
      <DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
        <DropdownMenuTrigger asChild>
          ...
          >
            <div className="flex ml-1 aspect-square size-6 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground">
